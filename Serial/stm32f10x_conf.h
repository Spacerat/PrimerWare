...
//kept from lib v1.0 - probably needs to be adapted
#define _SCB
...
// DAN #define HSE_Value    ((u32)12000000) /* Value of the External oscillator in Hz*/

/* In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value */
// DAN #define HSEStartUp_TimeOut    ((u16)0x0500) /* Time out for HSE start up */
